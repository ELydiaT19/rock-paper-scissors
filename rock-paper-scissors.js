...
function sumEachPlayerScore() {
    ...
    computerScoreTotal = computerScore.reduce((total, amount) => total + amount, 0);
}

function displayScores() {
    document.getElementById("player-score-total").innerText = playerScoreTotal;
    document.getElementById("computer-score-total").innerText = computerScoreTotal; 
}
...
function announceWinner() {
    if (playerScoreTotal === 5 || computerScoreTotal === 5) {
        if (playerScoreTotal > computerScoreTotal) {
            ...
            document.getElementById("game-winner").innerText = "The computer won the game 🤖";
        }
